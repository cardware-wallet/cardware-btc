...
function __wbg_adapter_24(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h349e78a55a944c19(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {(string)[]}
*/
export function convert_psbt_to_qr(psbt_bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(psbt_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.convert_psbt_to_qr(retptr, ptr0, len0);
...
*/
export function raw_broadcast(transaction, esplora_url) {
    ...
    const ret = wasm.raw_broadcast(ptr0, len0, ptr1, len1);
...
export class Wallet {
    ...
    * @returns {Promise<string>}
    */
    sync_to_depth(max_depth) {
        const ptr0 = passStringToWasm0(max_depth, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wallet_sync_to_depth(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    * @param {string} transaction
    ...
    * @returns {(string)[]}
    */
    send(recipient_addrs, amounts, fee) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArrayJsValueToWasm0(recipient_addrs, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArray64ToWasm0(amounts, wasm.__wbindgen_malloc);
            const len1 = WASM_VECTOR_LEN;
            wasm.wallet_send(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1, fee);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    * @returns {bigint}
    */
    estimate_fee(recipient_addrs, amounts, number_of_blocks) {
        const ptr0 = passArrayJsValueToWasm0(recipient_addrs, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray64ToWasm0(amounts, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wallet_estimate_fee(this.__wbg_ptr, ptr0, len0, ptr1, len1, number_of_blocks);
    ...
    * @returns {bigint}
    */
    estimate_sweep_fee(number_of_blocks) {
        const ret = wasm.wallet_estimate_sweep_fee(this.__wbg_ptr, number_of_blocks);
        return BigInt.asUintN(64, ret);
    }
    /**
    * @param {(string)[]} utxo_vec
    */
    set_trusted_pending(utxo_vec) {
        const ptr0 = passArrayJsValueToWasm0(utxo_vec, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.wallet_set_trusted_pending(this.__wbg_ptr, ptr0, len0);
    }
    /**
    * @returns {(string)[]}
    */
    get_trusted_pending() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wallet_get_trusted_pending(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    unconfirmed_balance() {
        const ret = wasm.wallet_unconfirmed_balance(this.__wbg_ptr);
        return BigInt.asUintN(64, ret);
    }
    /**
    * @returns {string}
    */
    address() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wallet_address(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    new_address(derivation_path) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.wallet_new_address(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred2_0 = r0;
            deferred2_1 = r1;
...
export function __wbindgen_closure_wrapper749(arg0, arg1, arg2) {
